...
library(readr)
person <- read_csv("docs/PUMA_p_variables.csv")
hhold <- read_csv("docs/PUMA_h_variables.csv")
...
B01001 <- read_excel("docs/acs_pums_mappings.xlsx", sheet = "B01001")
...
B15001 <- read_excel("docs/acs_pums_mappings.xlsx", sheet = "B15001")
...
B19037_age <- read_excel("docs/acs_pums_mappings.xlsx", sheet = "B19037_age")
knitr::kable(B19037_age, caption = '**B19037 Householder Age Mapping**',booktabs = TRUE)
B19037_income <- read_excel("docs/acs_pums_mappings.xlsx", sheet = "B19037_income")
...
B25007_age <- read_excel("docs/acs_pums_mappings.xlsx", sheet = "B25007_age")
knitr::kable(B25007_age, caption = '**B25007 Householder Age Mapping**',booktabs = TRUE)
B25007_tenure <- read_excel("docs/acs_pums_mappings.xlsx", sheet = "B25007_tenure")
